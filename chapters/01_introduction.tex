...
\end{minted}
    Assume there are two variables \texttt{malloc\_f} and \texttt{free\_f} that point to the currently used implementation of the functions \texttt{malloc} and \texttt{free}, respectively.
...
The implementation of \cpo\ is available under \todo{TODO}. Parts of this thesis have been submitted to~\cite{c2po}.
