...
The abstract effects of each type of edge is described in the following.
...
For example, if $x$ and $e$ are pointers, the \cpo\ analysis removes all old equalities that were talking about $x$, as the value of $x$ might have changed.
