...
\todo[inline]{instead of this random paragraph, add the constraints with enter and combine. Or don't, if it's too complicated.
Or write it in concrete semantics?}
