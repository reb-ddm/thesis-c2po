...
\begin{itemize}
    \item Let $p \equiv (t_1 = z + t_2)$ and let $t_1'=\tau\,t_1$ and $t_2'=\tau\,t_2$.
          \begin{itemize}
              ...
              \item Otherwise, we compute the $\closure{t_1}{z}{t_2}{P}$.
                    ...
                    $B'$ is the result of updating all mappings of $B$ to the new representatives.
    ...
    \item Let $p \equiv (bl(t_1) \neq bl(t_2))$. Again, let $t_1'=\tau\,t_1$ and $t_2'=\tau\,t_2$.
          \begin{itemize}
              ...
              \item Otherwise, we add the mapping $t_1' \mapsto \{t_2'\}$ to $B$, or if $B$ already contains a mapping $t_1' \mapsto T$, then we add $t_2'$ to $T$.
                    We set $D' = D[\F[k_1] \land p]$.
          \end{itemize}
