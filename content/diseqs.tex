...
\todo{define closure of disequalities with also as a parameter the partition and the block diseqs}
...
\todo[inline]{If you also define a normalize(B) or something, then the definition of meet will be easier.}
