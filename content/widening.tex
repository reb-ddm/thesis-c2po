...
\begin{example}\label{ex:widen}\todo{fix and add graph}
  If we consider the sequence of conjunctions $\Psi_n$ from \cref{ex:widen-ascending-chain}, the automaton representation $M$\todo{what is P} is a cycle of length $2^n$.
