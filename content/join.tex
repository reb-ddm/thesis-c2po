...
As before, we first extend the two partitions to the same set of terms $\T$ that contains all terms from both partitions.
...
as the equivalence classes of $P_1$ and $P_2$ might be divided into multiple equivalence classes in $P_3$.
...
and computing their closure with respect to the closure under quantitative equalities rule \labelcref{item:closure-under-quantitative-equalities}.
