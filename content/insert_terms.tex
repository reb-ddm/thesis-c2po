...
\begin{example}
    ...
    \todo{The same example is already somewhere else. But mainly, $\Pi$ doesn't exist any more}
\end{example}
...
Then we perform the operation $\union{*(z + t)}{\otau\,s_2}{z'}$.\todo{maybe closure?}
