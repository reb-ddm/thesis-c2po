...
\end{itemize}
%--------
This algorithm is similar to congruence closure \cite{cc-}, but it is restricted to a unary uninterpreted function symbol $*$ and extended with integer offsets.
