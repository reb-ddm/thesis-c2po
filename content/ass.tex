...
\begin{figure}
	...
	\end{tikzpicture}
	\caption[Another possibility of two pointers $t_1$ and $z+ t_2$ that have an overlapping region.]{Visualization of two pointers $z+ t_2$ and $t_1$ that have an overlapping region.
